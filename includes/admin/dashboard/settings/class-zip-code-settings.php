                            ...
                            <?php else: ?>
                                <?php foreach ($zip_codes as $zip): ?>
                                    <tr>
                                        ...
                                        <td><?php echo ($zip->price_adjustment >= 0 ? '+' : '') . \VandelBooking\Helpers::formatPrice($zip->price_adjustment); ?></td>
                                        <td><?php echo \VandelBooking\Helpers::formatPrice($zip->service_fee); ?></td>
...
<a href="#" 
   ...
   data-is-serviceable="<?php echo esc_attr($zip->is_serviceable); ?>">
    <?php _e('Edit', 'vandel-booking'); ?>
                                            ...
                                            <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=vandel-dashboard&tab=settings&section=zip-codes&action=delete_zip_code&zip_code=' . urlencode($zip->zip_code)), 'delete_zip_code_' . $zip->zip_code)); ?>" class="vandel-delete-zip-code"><?php _e('Delete', 'vandel-booking'); ?></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
        ...
        <form method="post" action="">
            ...
            <div class="vandel-form-row">
                <div class="vandel-col">
                    ...
                    <div class="vandel-input-group">
                        <span class="vandel-input-prefix"><?php echo \VandelBooking\Helpers::getCurrencySymbol(); ?></span>
                        <input type="number" name="price_adjustment" id="edit-price-adjustment" step="0.01" min="-100" max="100" class="widefat">
                    </div>
                </div>
                <div class="vandel-col">
                    <label><?php _e('Service Fee', 'vandel-booking'); ?></label>
                    <div class="vandel-input-group">
                        <span class="vandel-input-prefix"><?php echo \VandelBooking\Helpers::getCurrencySymbol(); ?></span>
                        <input type="number" name="service_fee" id="edit-service-fee" step="0.01" min="0" class="widefat">
                    </div>
                </div>
            </div>
